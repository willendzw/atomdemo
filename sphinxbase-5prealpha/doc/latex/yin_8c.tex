...
\mbox{\label{yin_8c_a3befedc0027bb60c5c4b571a6a5c2e03}} 
int {\bfseries thresholded\+\_\+search} (int32 $\ast$diff\+\_\+window, fixed32 threshold, int start, int end)
\item 
...
int \textbf{ yin\+\_\+read} (\textbf{ yin\+\_\+t} $\ast$pe, uint16 $\ast$out\+\_\+period, uint16 $\ast$out\+\_\+bestdiff)
...
\mbox{\label{yin_8c_a5d4ceba1aed1fcc8e10f6408a271b294}} 
\index{yin.\+c@{yin.\+c}!yin\+\_\+read@{yin\+\_\+read}}
\index{yin\+\_\+read@{yin\+\_\+read}!yin.\+c@{yin.\+c}}
\subsubsection{yin\+\_\+read()}
{\footnotesize\ttfamily int yin\+\_\+read (\begin{DoxyParamCaption}\item[{\textbf{ yin\+\_\+t} $\ast$}]{pe,  }\item[{uint16 $\ast$}]{out\+\_\+period,  }\item[{uint16 $\ast$}]{out\+\_\+bestdiff }\end{DoxyParamCaption})}
